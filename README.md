...
| <a name="input_datadog_api_key"></a> [datadog\_api\_key](#input\_datadog\_api\_key) | Datadog API key. Can be provided as a string or as an object with 'name' and optional 'version' fields to reference a secret. | `any` | n/a | yes |
